...
def process_log_file(file_path, sheet, row_num):
    with open(file_path, 'r') as file:
        ...
        for line in file:
            #line = line.strip()
            #matches = re.search(pattern, line,re.MULTILINE)
            ...
            if matches:
                ...
                #TODO check the headers and the data is the same as the csv
...
def main():
    ...
    # check the passed input directory and analyze ONLY the files from the extension used, if present otherwise analyze all file present in the directory
        ...
        print("ONLY the files from the extension used in the specified directory")
